      ...
      <div className="container-none md:container lg:container mx-auto py-sp-big px-3">
        <div className="flex">
          <div className="w-2/5">
            ...
            <p className='lg:text-heading2 text-heading1 text-secondary font-semibold'>Moglix is an end-to end supply chain solution company focused on tech-enabled MRO sourcing, custom manufacturing procurement and infrastructure industry supplies.</p>
          </div>
