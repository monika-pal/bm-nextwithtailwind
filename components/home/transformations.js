...
export default function transformations() {
  return (
    <div>
      <section className='relative py-sp-big pt-0 sm:py-[50px]'>
        <div className='container md:container lg:container mx-auto py-5 px-3 md:px-0 sm:px-2 text-center'>
          <div className='flex flex-wrap '>
            <div className='w-1/2 pr-[20px] md:pl-0 md:w-full sm:w-full'>
              <h2 className='text-lg text-brand font-medium text-left mb-2'>Transformations</h2>
              <p className='text-textxl text-secondary font-regular items-center text-left leading-[41px] pr-2 mb-[40px] sm:text-xl'>
              ...
              <div className='flex sm:flex-wrap sm:mb-6'>
            ...
            <div className='w-1/2 px-[20px] md:w-full md:mt-6 md:px-0 sm:px-0 sm:w-full'>
              <div className="relative transformation-img-section before:bg-[url('/assets/img/transformation.png')] before:bg-no-repeat before:bg-contain pl-[80px] pb-[80px] before:left-0 before:bottom-3 before:absolute before:top-0 before:right-0 before:z-0  sm:pl-[40px] sm:pb-[40px]">
